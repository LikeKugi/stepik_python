...
print(filter(lambda x: 99 < x < 1000, numbers))
print(filter(lambda x: x % 5 == 2, filter(lambda x: 99 < x < 1000, numbers)))

maped_numbers = map(lambda x: x ** 3, filter(lambda x: x % 5 == 2, filter(lambda x: 99 < x < 1000, numbers)))
print(*maped_numbers,sep='\n')
