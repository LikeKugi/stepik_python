...
for a pocket of warmth in the darkest past, nothing of her subsists within the hollows and dells of memory, over which, 
...
short_words = {word.strip('():;,.!?').lower() for word in sentence.split() if len(word.strip(':;,.!?')) < 4}
